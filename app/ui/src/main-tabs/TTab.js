        ...
        <div className="container-fluid" style={{ height:"100%" }}>
          <div className="d-flex flex-row" style={{ height:"100%" }}>
            <div name="project" onMouseOver={() => this.toolbarMenuHover('project')} onClick={(e) => this.openToolbarMenu('project')}
              className={(this.state.navItem === "project") ? "menuItem align-self-center text-center z-depth-1-half" : "menuItem align-self-center text-center"}>
            ...
            <div name="tools" onMouseOver={() => this.toolbarMenuHover('tools')} onClick={(e) => this.openToolbarMenu('tools')}
              className={(this.state.navItem === "tools") ? "menuItem align-self-center text-center z-depth-1-half" : "menuItem align-self-center text-center"}>
            ...
            <div name="reporting" onMouseOver={() => this.toolbarMenuHover('reporting')} onClick={(e) => this.openToolbarMenu('reporting')}
              className={(this.state.navItem === "reporting") ? "menuItem align-self-center text-center z-depth-1-half" : "menuItem align-self-center text-center"}>
            ...
            <div name="settings" onMouseOver={() => this.toolbarMenuHover('settings')} onClick={(e) => this.openToolbarMenu('settings')}
              className={(this.state.navItem === "settings") ? "menuItem align-self-center text-center z-depth-1-half" : "menuItem align-self-center text-center"}>
            ...
            <div name="more" onMouseOver={() => this.toolbarMenuHover('more')} onClick={(e) => this.openToolbarMenu('more')}
              className={(this.state.navItem === "more") ? "menuItem align-self-center text-center z-depth-1-half" : "menuItem align-self-center text-center"}>
